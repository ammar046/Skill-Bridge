...
function SkillsCard() {
  ...
  async function downloadPdf() {
    ...
    doc.text(
      "Sources: ISCO-08 ILO taxonomy · Frey & Osborne (2017) LMIC-adjusted automation scores · World Bank HCI 2024 · ILOSTAT 2024",
      M,
      A4_H - 16,
    );
    doc.text("This credential was generated by the UNMAPPED Protocol — open infrastructure for the informal economy.", M, A4_H - 7);
